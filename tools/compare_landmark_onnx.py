...
input_size = int(sys.argv[3])  # 128 or 256
...
print("all-out0:", all_outputs1[0].shape, np.abs(all_outputs1[0] - all_outputs2[0]).max())
print("all-out1:", all_outputs1[1].shape, np.abs(all_outputs1[1] - all_outputs2[1]).max())
